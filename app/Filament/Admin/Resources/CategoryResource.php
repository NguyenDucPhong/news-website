...
class CategoryResource extends Resource implements HasShieldPermissions
{
    ...
    protected static ?string $modelLabel = 'Danh mục'; // customize nhan cua model

    protected static bool $hasTitleCaseModelLabel = false; // khong viet hoa chu cai dau tien trong nhan cua model

    protected static ?string $activeNavigationIcon = 'heroicon-s-clipboard'; // icon hien thi khi trang hien tai dang duoc chon
